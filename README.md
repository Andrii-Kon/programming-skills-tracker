...
1. Збережіть цей текст у файлі `README.md` у кореневій директорії вашого репозиторію.
2. Переконайтеся, що всі посилання працюють коректно.
3. За потреби адаптуйте текст під ваші вимоги.

Дайте знати, якщо потрібні уточнення чи допомога! 😊
